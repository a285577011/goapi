...
/**
 * This is the model class for table "bd_team".
 *
 ...
 */
class BdTeam extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['team_code', 'team_long_name'], 'required'],
            [['team_type', 'team_position', 'team_status', 'opt_id'], 'integer'],
