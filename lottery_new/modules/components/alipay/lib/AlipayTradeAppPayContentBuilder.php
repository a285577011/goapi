<?php
/* *
 * 功能：支付宝App支付(alipay.trade.app.pay)接口业务参数封装
 * 版本：2.0
 * 修改日期：2017-05-01
 * 说明：
...
class AlipayTradeAppPayContentBuilder
{
    ...
    public function setDisable_pay_channels($disable_pay_channels)
    {
        $this->disable_pay_channels = $disable_pay_channels;
        $this->bizContentarr['disable_pay_channels'] = $disable_pay_channels;
    }

    public function getDisable_pay_channels()
    {
