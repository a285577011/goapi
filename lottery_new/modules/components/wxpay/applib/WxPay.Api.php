...
require_once \Yii::$app->basePath . "/modules/components/wxpay/applib/WxPay.Exception.php";
require_once \Yii::$app->basePath . "/modules/components/wxpay/applib/WxPay.Config.php";
require_once \Yii::$app->basePath . "/modules/components/wxpay/applib/WxPay.Data.php";
