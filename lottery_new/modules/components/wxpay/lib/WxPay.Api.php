...
require_once \Yii::$app->basePath . "/modules/components/wxpay/lib/WxPay.Exception.php";
require_once \Yii::$app->basePath . "/modules/components/wxpay/lib/WxPay.Config.php";
require_once \Yii::$app->basePath . "/modules/components/wxpay/lib/WxPay.Data.php";
