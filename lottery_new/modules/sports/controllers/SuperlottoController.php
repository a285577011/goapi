...
class SuperlottoController extends \yii\web\Controller {

    const LOTTERY_CODE = "2001";
    ...
    public function playOrder($custNo, $userId, $storeId, $storeCode, $source = 1, $sourceId = "", $boolStr = false, $outType) {
        if (Yii::$app->request->isAjax || 1) {
            $layName = Constants::DLT_PLAYNAME;
...
//        @file_put_contents('D:\\1.txt', $orderId);
