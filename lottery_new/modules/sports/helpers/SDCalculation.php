...
class SDCalculation {
     ...
     */
    public static function sd115Fun_RenPu($nums, $n) {
        $areas = explode(',', $nums);
     ...
     * @return integer,boolen
     */
    public static function sd115Fun_RenDan($nums, $n) {
        $areas = explode('#', $nums);
     ...
     * @return integer,boolen
     */
    public static function sd115Fun_QianOneZhi($nums) {
        $areas = explode(',', $nums);
     ...
     * @return integer,boolen
     */
    public static function sd115Fun_QianTwoZhi($nums) {
        $areas = explode(';', $nums);
     ...
     * @return integer,boolen
     */
    public static function sd115Fun_QianThreeZhi($nums) {
        $areas = explode(';', $nums);
        $oneArr = explode(',', $areas[0]);
        $twoArr = explode(',', $areas[1]);
     ...
     * @return integer,boolen
     */
    public static function sd115Fun_QianZuPu($nums, $n) {
        $areas = explode(',', $nums);
        $comb = Commonfun::getCombination(count($areas), $n);
        return $comb;
    }
     ...
     * @return integer,boolen
     */
    public static function sd115Fun_QianZuDan($nums, $n) {
        $areas = explode('#', $nums);
        $danArr = explode(',', $areas[0]);
        $tuoArr = explode(',', $areas[1]);
        $m = $n - count($danArr);
     ...
     * @return integer,boolen
     */
    public static function sd115Fun_LeSan($nums) {
        $areas = explode(';', $nums);
        $oneArr = explode(',', $areas[0]);
        $twoArr = explode(',', $areas[1]);
        $threeArr = explode(',', $areas[2]);
   ...
   /**
     ...
     * @return integer,boolen
     */
    public static function sd115Fun_LeXuanPu($nums, $n) {
        $areas = explode(',', $nums);
        $comb = Commonfun::getCombination(count($areas), $n);
        return $comb;
    }
     ...
     * @return integer,boolen
     */
    public static function sd115Fun_LeXuanDan($nums, $n) {
        $areas = explode('#', $nums);
        $danArr = explode(',', $areas[0]);
        $tuoArr = explode(',', $areas[1]);
        $m = $n - count($danArr);
     ...
     * @return boolean
     */
    public static function sd115Note_200702($nums) {
     ...
     * @return array
     */
    public static function sd115Note_200703($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function sd115Note_200704($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function sd115Note_200705($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function sd115Note_200706($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function sd115Note_200707($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function sd115Note_200708($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function sd115Note_200712($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function sd115Note_200713($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function sd115Note_200714($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function sd115Note_200715($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function sd115Note_200716($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function sd115Note_200717($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function sd115Note_200718($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function sd115Note_200722($nums) {
     ...
     * @return array
     */
    public static function sd115Note_200723($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function sd115Note_200724($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function sd115Note_200725($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function sd115Note_200726($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function sd115Note_200727($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function sd115Note_200728($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function sd115Note_200731($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function sd115Note_200732($nums) {
        $balls = explode(';', trim($nums, ","));
        $count = Commonfun::getCombination(count($balls), 2);
        $orders = [];
        if ($count == 1) {
     ...
     * @return array
     */
    public static function sd115Note_200733($nums) {
        $balls = explode(';', trim($nums, ","));
        $count = Commonfun::getCombination(count($balls), 3);
        $orders = [];
        if ($count == 1) {
     ...
     * @return array
     */
    public static function sd115Note_200734($nums) {
        $balls = explode(',', trim($nums, ","));
        $count = Commonfun::getCombination(count($balls), 2);
        $orders = [];
        if ($count == 1) {
     ...
     * @return array
     */
    public static function sd115Note_200735($nums) {
        $balls = explode(',', trim($nums, ","));
        $count = Commonfun::getCombination(count($balls), 3);
        $orders = [];
        if ($count == 1) {
     ...
     * @return array
     */
    public static function sd115Note_200741($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function sd115Note_200742($nums) {
     ...
     * @return array
     */
    public static function sd115Note_200743($nums) {
        $areas = explode(';', trim($nums, ";"));
        if (count($areas) == 3) {
            $balls1 = explode(',', $areas[0]);
            $balls2 = explode(',', $areas[1]);
     ...
     * @return array
     */
    public static function sd115Note_200744($nums) {
        $balls = explode(',', trim($nums, ","));
        if (!is_array($balls) || count($balls) < 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function sd115Note_200745($nums) {
        $balls = explode(',', trim($nums, ","));
        if (!is_array($balls) || count($balls) < 3) {
            return false;
        }
     ...
     * @return array
     */
    public static function sd115Note_200754($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function sd115Note_200755($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function sd115Note_200763($nums) {
        $balls = explode(';', trim($nums, ","));
        $count = Commonfun::getCombination(count($balls), 3);
        $orders = [];
        if ($count == 1) {
     ...
     * @return array
     */
    public static function sd115Note_200764($nums) {
        $balls = explode(',', trim($nums, ","));
        $count = Commonfun::getCombination(count($balls), 4);
        $orders = [];
        if ($count == 1) {
     ...
     * @return array
     */
    public static function sd115Note_200765($nums) {
        $balls = explode(',', trim($nums, ","));
        $count = Commonfun::getCombination(count($balls), 5);
        $orders = [];
        if ($count == 1) {
     ...
     * @return array
     */
    public static function sd115Note_200766($nums) {
        $areas = explode(';', trim($nums, ";"));
        if (count($areas) == 3) {
            $balls1 = explode(',', $areas[0]);
            $balls2 = explode(',', $areas[1]);
     ...
     * @return array
     */
    public static function sd115Note_200767($nums) {
        $balls = explode(',', trim($nums, ","));
        if (!is_array($balls) || count($balls) < 4) {
            return false;
        }
     ...
     * @return array
     */
    public static function sd115Note_200768($nums) {
        $balls = explode(',', trim($nums, ","));
        if (!is_array($balls) || count($balls) < 5) {
            return false;
        }
     ...
     * @return array
     */
    public static function sd115Note_200769($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function sd115Note_200770($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
