...
class HBCalculation {
     ...
     */
    public static function hb115Fun_RenPu($nums, $n) {
        $areas = explode(',', $nums);
     ...
     * @return integer,boolen
     */
    public static function hb115Fun_RenDan($nums, $n) {
        $areas = explode('#', $nums);
     ...
     * @return integer,boolen
     */
    public static function hb115Fun_QianOneZhi($nums) {
        $areas = explode(',', $nums);
     ...
     * @return integer,boolen
     */
    public static function hb115Fun_QianTwoZhi($nums) {
        $areas = explode(';', $nums);
     ...
     * @return integer,boolen
     */
    public static function hb115Fun_QianThreeZhi($nums) {
        $areas = explode(';', $nums);
        $oneArr = explode(',', $areas[0]);
        $twoArr = explode(',', $areas[1]);
     ...
     * @return integer,boolen
     */
    public static function hb115Fun_QianZuPu($nums, $n) {
        $areas = explode(',', $nums);
        $comb = Commonfun::getCombination(count($areas), $n);
        return $comb;
    }
     ...
     * @return integer,boolen
     */
    public static function hb115Fun_QianZuDan($nums, $n) {
        $areas = explode('#', $nums);
        $danArr = explode(',', $areas[0]);
        $tuoArr = explode(',', $areas[1]);
        $m = $n - count($danArr);
     ...
     * @return boolean
     */
    public static function hb115Note_201002($nums) {
     ...
     * @return array
     */
    public static function hb115Note_201003($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function hb115Note_201004($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function hb115Note_201005($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function hb115Note_201006($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function hb115Note_201007($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function hb115Note_201008($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function hb115Note_201012($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function hb115Note_201013($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function hb115Note_201014($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function hb115Note_201015($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function hb115Note_201016($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function hb115Note_201017($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function hb115Note_201018($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function hb115Note_201022($nums) {
     ...
     * @return array
     */
    public static function hb115Note_201023($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function hb115Note_201024($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function hb115Note_201025($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function hb115Note_201026($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function hb115Note_201027($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function hb115Note_201028($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function hb115Note_201031($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function hb115Note_201032($nums) {
        $balls = explode(';', trim($nums, ","));
        $count = Commonfun::getCombination(count($balls), 2);
        $orders = [];
        if ($count == 1) {
     ...
     * @return array
     */
    public static function hb115Note_201033($nums) {
        $balls = explode(';', trim($nums, ","));
        $count = Commonfun::getCombination(count($balls), 3);
        $orders = [];
        if ($count == 1) {
     ...
     * @return array
     */
    public static function hb115Note_201034($nums) {
        $balls = explode(',', trim($nums, ","));
        $count = Commonfun::getCombination(count($balls), 2);
        $orders = [];
        if ($count == 1) {
     ...
     * @return array
     */
    public static function hb115Note_201035($nums) {
        $balls = explode(',', trim($nums, ","));
        $count = Commonfun::getCombination(count($balls), 3);
        $orders = [];
        if ($count == 1) {
     ...
     * @return array
     */
    public static function hb115Note_201041($nums) {
        $balls = explode(',', trim($nums, ","));
     ...
     * @return array
     */
    public static function hb115Note_201042($nums) {
     ...
     * @return array
     */
    public static function hb115Note_201043($nums) {
        $areas = explode(';', trim($nums, ";"));
        if (count($areas) == 3) {
            $balls1 = explode(',', $areas[0]);
            $balls2 = explode(',', $areas[1]);
     ...
     * @return array
     */
    public static function hb115Note_201044($nums) {
        $balls = explode(',', trim($nums, ","));
        if (!is_array($balls) || count($balls) < 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function hb115Note_201045($nums) {
        $balls = explode(',', trim($nums, ","));
        if (!is_array($balls) || count($balls) < 3) {
            return false;
        }
     ...
     * @return array
     */
    public static function hb115Note_201054($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
     ...
     * @return array
     */
    public static function hb115Note_201055($nums) {
        $area = explode('#', trim($nums, "#"));
        if (count($area) != 2) {
            return false;
        }
