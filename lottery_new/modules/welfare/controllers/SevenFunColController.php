...
/**
 * SevenFunCol controller for the `welfare` module
 */
class SevenFunColController extends Controller {
...
//        }
        ...
        $betNums = '';
        $playName = [];
        $playParam = Constants::QLC_PLAYNAME;
