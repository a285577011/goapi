...
<div style="width: 100%;float: left;">
    *重要提示：中奖单注超过1万元的订单请店主自主扣税后再兑奖，手工出票兑奖请店主认真审核。
</div>
<table class="table" id="pwTable">
    <thead>
        <tr>
            ...
            <th style="text-align: center;">实派金额(元)</th>
            <th style="text-align: center;">是否取票</th>
            <th style="text-align: center;">派奖方式</th>
...
<script type="text/javascript">
    var total = 0;
    var params = {deal_status: "2,3", status: 4};
            ...
            success: function (json) {
                ...
                $.each(json["result"]["list"], function (key, val) {
                    html += '<tr data-key="' + val["lottery_order_code"] + '">\n\
                            ...
                            <td class="textCenter">' + val["award_amount"] + '</td>\n\
                            <td class="textCenter">否</td>\n\
                            <td class="textCenter">自动/手动</td>\n\
                            <td class="textCenter">' + val["award_time"] + '</td>\n\
                            ...
                            ' + ((val["status"] == 4 && val["deal_status"] == 1) ? ('<span class="handle pointer" onclick="playAwards(\'' + val["lottery_order_code"] + '\')"> 兑奖 </span> | ') : "") + '\n\
