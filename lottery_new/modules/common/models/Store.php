...
class Store extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['store_code', 'user_id', 'company_id', 'store_type', 'cert_status', 'real_name_status', 'status', 'opt_id', 'amap_id', 'his_win_nums', 'made_nums', 'consignment_type'], 'integer'],
            [['cust_no'], 'required'],
            [['modify_time', 'create_time', 'update_time', 'contract_start_date', 'contract_end_date'], 'safe'],
            [['support_bonus', 'his_win_amount'], 'number'],
            [['cust_no', 'store_name', 'coordinate', 'review_remark', 'store_qrcode', 'sale_lottery'], 'string', 'max' => 100],
