...
protected function findViewFile($view, $context = null)
    {
        ...
        if (strncmp($view, '@', 1) === 0) {
            ...
            // e.g. "//layouts/main"
            $file = Yii::$app->basePath.DIRECTORY_SEPARATOR."web".DIRECTORY_SEPARATOR."views". DIRECTORY_SEPARATOR . ltrim($view, '/');
        } elseif (strncmp($view, '/', 1) === 0) {
            // e.g. "/site/index"
            if (Yii::$app->controller !== null) {
            	$file = Yii::$app->basePath.DIRECTORY_SEPARATOR."web".DIRECTORY_SEPARATOR."views".DIRECTORY_SEPARATOR.Yii::$app->controller->module->id. DIRECTORY_SEPARATOR . ltrim($view, '/');
            } else {
                throw new InvalidCallException("Unable to locate view file for view '$view': no active controller.");
            }
        } elseif (strncmp($view, '///', 3) === 0) {
            // e.g. "//layouts/main"
       		if (Yii::$app->controller !== null) {
            	$file = Yii::$app->basePath.DIRECTORY_SEPARATOR."web".DIRECTORY_SEPARATOR."views". DIRECTORY_SEPARATOR . ltrim($view, '/');
            } else {
